...
class OgrenciDersVeIlgiAlaniSetShowAlertWidget extends StatefulWidget {
  const OgrenciDersVeIlgiAlaniSetShowAlertWidget({required Map<String, dynamic> model, super.key}) : _model = model;
  final Map<String, dynamic> _model;
  @override
  State<OgrenciDersVeIlgiAlaniSetShowAlertWidget> createState() => _OgrenciDersVeIlgiAlaniSetShowAlertWidgetState();
}

class _OgrenciDersVeIlgiAlaniSetShowAlertWidgetState extends State<OgrenciDersVeIlgiAlaniSetShowAlertWidget> {
                ...
                ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      for (int dersId in _selectDerslerIdList) {
                        ...
                        if (count == 0) {
                          if (allDersSize <= _state.maxOgrenciAlinacakDers!) {
                            await SqlInsertService.addOgrenciDers([dersId], widget._model["id"], SqlTableName.ogrenciDersleri);
                          }
                        }
                      }
                      ...
                      for (int ilgiAlanId in _selectIlgiAlanlariIdList) {
                        ...
                        if (count == 0) {
                          await SqlInsertService.addOgrenciIlgiAlani([ilgiAlanId], widget._model["id"], SqlTableName.ogrenciIlgiAlanlari);
                        }
                      }
                    },
